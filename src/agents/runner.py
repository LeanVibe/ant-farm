...
class DeveloperAgent(BaseAgent):
    ...
    async def _proactive_development_work(self) -> None:
        ...
        try:
            ...
            logger.error(
                "Proactive development work failed", agent=self.name, error=str(e)
            )
...
class ArchitectAgent(BaseAgent):
    ...
    async def _proactive_architecture_work(self) -> None:
        ...
        try:
            ...
            logger.error(
                "Proactive architecture work failed", agent=self.name, error=str(e)
            )
...
class ResearchAgent(BaseAgent):
    ...
    async def _proactive_research_work(self) -> None:
        ...
        try:
            ...
            logger.error(
                "Proactive research work failed", agent=self.name, error=str(e)
            )
...
async def main():
    ...
    parser = argparse.ArgumentParser(
        description="LeanVibe Agent Hive 2.0 - Agent Runner"
    )
    parser.add_argument(
        "--type",
        required=True,
